...
var DefaultBlocks = [][]dataprep.Tag{{dataprep.TagBattles, dataprep.TagAvgDamage, dataprep.TagAvgTier}, {dataprep.TagWN8, dataprep.TagDamageRatio}, {dataprep.TagWinrate, dataprep.TagAccuracy, dataprep.TagSurvivalPercent}}
