...
var DefaultBlocks = [][]dataprep.Tag{{dataprep.TagBattles, dataprep.TagWinrate}, {dataprep.TagAvgDamage, dataprep.TagWN8, dataprep.TagAccuracy}, {dataprep.TagAvgTier, dataprep.TagDamageRatio, dataprep.TagSurvivalPercent}}
